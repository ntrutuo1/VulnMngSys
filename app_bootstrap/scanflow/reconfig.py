...
from infrastructure.backup_manager import backup_manager
from infrastructure.logging.system_logger import logger
from infrastructure.service_verifier import service_verifier
...
def run_reconfig_script(
    report: dict[str, Any],
    app_root: Path,
    selected_rule_ids: list[str] | None = None,
) -> dict[str, Any]:
    return RemediationPipeline().apply(report, app_root, selected_rule_ids)
