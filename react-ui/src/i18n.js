  ...
  en: {
    translation: {
      ...
      scanType: {
        ...
        iisMsfDesc: 'Runs focused CVE checks against IIS / HTTP.sys / Web Deploy / WSUS through local msfrpcd and PowerShell.',
      },
      iisAudit: {
        connectionTitle: 'Metasploit RPC Connection',
        controlsTitle: 'IIS Critical CVE Audit Controls',
        resultsTitle: 'IIS Critical CVE Audit Results',
        notConnected: 'Not Connected',
        notConnectedDesc: 'Test a successful msfRPC connection above to enable the IIS audit scan.',
        connected: 'Connected',
        disconnected: 'Disconnected',
        testConnection: 'Test Connection',
        runAudit: 'Run IIS CVE Audit',
