...
from vulnmngsys_app.services.scanflow.facades.scan_view import get_scan_view
...
from vulnmngsys_app.services.scanflow.rule_catalog import get_rule_catalog
...
class ScanBackendView:
    ...
    def report_file(self) -> Path:
        return writable_reports_dir(self.app_root()) / "scan_compare_report.json"
    ...
    def run_profile_scan(
        ...
        *,
        ...
        dependencies = scan_dependencies(selected_profile)
